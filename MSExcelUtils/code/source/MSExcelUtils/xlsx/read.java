...

{
        ...
        throws ServiceException
	{
		...
		// data
					...
					if ( data != null)
					{
						...
						byteArrayStream = (ByteArrayInputStream)IDataUtil.get( dataCursor, "byteArrayStream" );
		...
		try{
			...
			else if (fileData != null)
			{
				if (fileData.length() > 0)
				    wb = new XSSFWorkbook(new ByteArrayInputStream(fileData.getBytes()));
			}
			else if (bin_array != null)
			{		
				wb = new XSSFWorkbook(new ByteArrayInputStream(bin_array));
			}
			else if (byteArrayStream != null)
			{
				wb = new XSSFWorkbook(byteArrayStream);
			}
	...
	public static String getCellDateFormat(XSSFCell cell)
	{
